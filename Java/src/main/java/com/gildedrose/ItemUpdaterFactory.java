...
class ItemUpdaterFactory {
    ...
    private static final String SULFURAS = resolve("GILDED_ROSE_SULFURAS", "gilded.rose.sulfuras", "Sulfuras, Hand of Ragnaros");
    private static final String AGED_BRIE = resolve("GILDED_ROSE_AGED_BRIE", "gilded.rose.aged-brie", "Aged Brie");
    private static final String BACKSTAGE_PASS = resolve("GILDED_ROSE_BACKSTAGE_PASS", "gilded.rose.backstage-pass", "Backstage passes to a TAFKAL80ETC concert");
    private static final String CONJURED_PREFIX = resolve("GILDED_ROSE_CONJURED_PREFIX", "gilded.rose.conjured-prefix", "Conjured");
